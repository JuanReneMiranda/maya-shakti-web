...
let proxy = {
    skew: 0
}, skewSetter = (0, _gsap.gsap).quickSetter(".skewElem", "skewY", "deg"), clamp = (0, _gsap.gsap).utils.clamp(-20, 20); // don't let the skew go beyond 20 degrees. 
...
},{}]},["j9r0q","ebWYT"], "ebWYT", "parcelRequire775a")
